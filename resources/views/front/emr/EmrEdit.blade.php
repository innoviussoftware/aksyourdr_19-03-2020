        ...
        $.ajax({
                ...
                success:function(res){
                  ...
                  $.each(res, function(index, value) {
                    var i=1;
                    $('#investigationdata').append('<div class="box-body"><input type="hidden" name="investigation[]" value="'+value.investigation_id+'"><input type="hidden" name="notes[]" value="'+value.note+'"><div class="form-group row"><div class="col-xs-9 -col-sm-6 col-md-10"><b>'+value.investigation_name+'</b></div><div class="col-xs-3 col-sm-6 col-md-2"><button type="button" style="background-color: #44729C;color:#fff;" class="remove_invest btn btn-xs" value="'+value.id+'"><i class="fa fa-minus" ></i></button></div> <div class="col-xs-9 -col-sm-6 col-md-10"><b>'+value.note+'</b></div></div></div>');
