              ...
              <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        @if(isset($doctors))
                          <input type="text" name="ask_id" class="form-control form-control-sm" minlength="2" value="{{ substr($doctors->ask_id,4) }}" id="ask_id_code">
                        @else
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        @if(isset($doctors))
                          <input type="text" name="doctor_code" class="form-control form-control-sm"  value="{{ $doctors->doctor_code }}" >
                        @else
                          <input type="text" name="doctor_code" class="form-control form-control-sm" value="{{ mt_rand(100000,999999) }}">
                        @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        @if(isset($doctors))
                          <input type="text" name="fees"   class="form-control form-control-sm" value="{{ $doctors->fees }}" maxlength="10" onkeypress="javascript:return isNumber(event)">
                        @else
                          <input type="text" name="fees"   class="form-control form-control-sm" value="{{ old('fees') }}" maxlength="10" onkeypress="javascript:return isNumber(event)">
                        @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        @if(isset($doctors))
                          <input type="text" name="discount" class="form-control form-control-sm" value="{{ $doctors->discount }}" maxlength="3" onkeypress="javascript:return isNumber(event)">
                        @else
                          <input type="text" name="discount"  class="form-control form-control-sm" value="0" maxlength="3" onkeypress="javascript:return isNumber(event)">
                        @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        @if(isset($doctors))
                          <input type="text" name="commision"   class="form-control form-control-sm" value="{{ $doctors->commision }}" maxlength="10" onkeypress="javascript:return isNumber(event)">
                        @else
                          <input type="text" name="commision"   class="form-control form-control-sm" value="{{ old('commision') }}" maxlength="10" onkeypress="javascript:return isNumber(event)">
                        @endif
                      </div>
                    </div>
