...
<div id="content">
        ...
        <div class="container-fluid">
             ...
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <b>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.wallet.index') }}" class="breadcrumb-item active crumb">Listing :: Commision</a></li>
                  </b>
                </ol>
            </nav>
          <!-- Page Heading -->
...
<script>
    $(document).ready(function () {
        var clinicdatatable = $('#clinicdatatable').DataTable({
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.wallet.walltearray') }}",
            "language": {
                "emptyTable": "No commisonwallet available"
            },
            "order": [[0, "desc"]],
        });
