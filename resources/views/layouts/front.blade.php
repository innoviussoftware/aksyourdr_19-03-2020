...
<input type="hidden" id="notificationcount" name="notificationcount" value="<?php echo $count;  ?>">
            ...
            $.ajax({
               ...
               success:function(data){
                  // alert(countnotification);
                    if(data == countnotification){
                        // const audioProgress = document.createElement('audio');
                        // audioProgress.src = "{{ asset('public/audio.mp3') }}";
                        // audioProgress.loop = true;
                        // audioProgress.pause();   

                    }else{
                        
                         // soundPlayer = new Audio('https://askurdr.com/newaskurdr/public/audio.mp3').play();
                        // const audioProgress = document.createElement('audio');
                        // audioProgress.src = "{{ asset('public/audio.mp3') }}";
                        // audioProgress.loop = true;
                        // audioProgress.play();
                        // window.onload = function () { document.getElementById("myAudio").play(); }
                        // window.addEventListener("load", function () { document.getElementById("myAudio").play(); });
                        // // alertring();
                        // setInterval(function(){
                        //     $('#notificationcount').val(data);
                        // }, 4000);
