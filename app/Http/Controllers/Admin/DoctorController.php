...
class DoctorController extends Controller
{
    ...
    */
    ...
    public function create()
    {
        ...
        return view('admin.doctor.create', compact('page','clinics','speciality','language','code'));
    }
    ...
    */
    ...
    public function edit($id)
    {
        ...
        $page = '/admin/doctor';
        $code=CountryCodeIso::get();
        return view('admin.doctor.create', compact('doctors','page','clinics','speciality','doctor_clinic','doctor_speciality','doctor_language','ded','de','doctor_days','doctor_daysendtime','doctor_days_checked','language','code'));
    }
...
$Clinic_NAME=Clinic::where('id',request('clinic_id'))->first();
        ...
        $update_attributes = array(
            ...
            'profile_pic'=>$path,
            'ask_id'=>isset($request->ask_id)?$clinic_name.'-'.$request->ask_id:$request->ask_id,
