    ...
    */
    ...
    public function specialitydoctorelistwithfilter(Request $request)
    {
        ...
        if($request->gender == 'all'){
            ...
            ->leftjoin('doctor_education', 'doctor_speciality.user_id', '=', 'doctor_education.user_id')
            ->leftjoin('doctor_experience', 'doctor_speciality.user_id', '=', 'doctor_experience.user_id')
            ->where('speciality_id',$request->speciality_id)->whereIn('consultant',$consultant)->orderBy('id', 'DESC')->groupBy('user_id')->get(); 
            foreach ($DoctorSpeciality as $key => $value) {
                $doctorid = $value->user_id;
                if($doctorid){
                    $language = DoctorLanguage::where('user_id',$doctorid)->get();
            ...
            ->leftjoin('doctor_education', 'doctor_speciality.user_id', '=', 'doctor_education.user_id')
            ->leftjoin('doctor_experience', 'doctor_speciality.user_id', '=', 'doctor_experience.user_id')
            ->where('speciality_id',$request->speciality_id)->whereIn('consultant',$consultant)->where('gender',$request->gender)->groupBy('user_id')->orderBy('id', 'DESC')->get();
            ...
            ->leftjoin('doctor_education', 'doctor_speciality.user_id', '=', 'doctor_education.user_id')
            ->leftjoin('doctor_experience', 'doctor_speciality.user_id', '=', 'doctor_experience.user_id')
            ->where('speciality_id',$request->speciality_id)->where('gender',$request->gender)->whereIn('consultant',$consultant)->groupBy('user_id')->orderBy('id', 'DESC')->get();
            foreach ($DoctorSpeciality as $key => $value) {
                $doctorid = $value->user_id;
                if($doctorid){
                    $language = DoctorLanguage::where('user_id',$doctorid)->get();
