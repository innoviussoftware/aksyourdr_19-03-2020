 ...
 */
    ...
    public function addpayment(Request $request)
    {
        ...
        if($call_type=='regular')
        {
            ...
            $patient_wallet=User::where('id',$doctorid)->first();//Patient Wallet Money
            ...
            {   
                ...
                $patient_wallet=User::where('id',$doctorid)->update(['wallet_money'=>$update_patient_wallet_money]);//Update Patient Wallet
